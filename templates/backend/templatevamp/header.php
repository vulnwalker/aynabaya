...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner" style="background-color:#363638 !important; ">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" target="_blank" href="<?=get_site('url');?>"><?=get_site('name');?></a>

      <div class="nav-collapse">
        <ul class="nav pull-right">

          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> <?=get_user_info('email');?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="<?=set_url('user#edit?id='.get_user_info('ID'));?>">Setting Akun</a></li>
